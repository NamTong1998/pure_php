...
<body>
	<form method="post" action="../../controllers/apps/LoginController.php" name="form" onsubmit="return formValidate()">
		<table class="formbox">
			<tr>
			...
			<tr>
				<td>  </td>
				<td> <input type="submit" value="Log In"> &nbsp;OR <a href="signup.php"> Sign Up </a> </td>
			</tr>
		</table>
	</form>
</body>
